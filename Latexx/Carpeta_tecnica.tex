...
\begin{minipage}{0.45\linewidth}
    \includegraphics[width=\linewidth, height=0.6\textheight, keepaspectratio]{Contacto/linkedin.png}
\end{minipage}
\hfill
...
\begin{figure}[H]
\centering
\includegraphics[height=6cm]{Esquematicos/image.png}
...
\begin{figure}[H]
\centering
\includegraphics[height=12cm]{Esquematicos/bombarele.png}
